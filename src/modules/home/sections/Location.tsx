      ...
      <div className="max-w-6xl mx-auto container-padding">
        <div className="grid-responsive-2 items-start">
          <div>
            ...
            <p className="text-fluid-base text-brand-dark/80 leading-relaxed mb-4">Projeto situado em região de características rurais com fácil conexão à malha urbana (trajetos e tempo médio de deslocamento serão divulgados com a evolução das etapas de infraestrutura viária).</p>
            <ul className="space-y-2 text-fluid-sm text-brand-dark/70">
          ...
          <div className="space-y-4">
            <div className="aspect-[4/3] w-full rounded-xl overflow-hidden shadow-soft bg-brand-dark/5 flex items-center justify-center text-brand-dark/50 text-fluid-sm">Mapa ilustrativo – coordenadas finais serão publicadas</div>
            <div className="grid-responsive-2 text-center">
              {['Centro Urbano','Rodovia Principal','Serviços','Área Verde'].map(t => (
                <div key={t} className="card-responsive bg-white border border-brand-green/10 flex flex-col gap-1">
                  ...
                  <span className="text-fluid-sm text-brand-dark/60">Dados em preparação</span>
                </div>
              ))}
            </div>
          </div>
